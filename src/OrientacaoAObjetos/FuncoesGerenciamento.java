...
public class FuncoesGerenciamento {
     ...
     */
    private static void AdicionarLivro(Autor autor, Scanner scanner, HashMap<Autor, ArrayList<Livro>> hashMap) {
        Livro livro;
        String titulo;
        int anoDeLancamento;
        ...
        do {
            ...
            titulo = scanner.nextLine().toLowerCase().strip();

            if (titulo.isEmpty()) {
                System.out.println("Campo titulo nao pode ser vazio");
            }
